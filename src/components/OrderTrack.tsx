...
export default function OrderTrack({ currentLanguage, orders }: OrderTrackProps) {
          ...
          <form onSubmit={handleTrackSubmit} className="flex flex-col sm:flex-row gap-3 pt-2">
            <div className="relative flex-1">
              ...
              <input
                ...
                className={`w-full py-3.5 px-4 rounded-xl text-xs bg-white/10 text-white border-2 border-transparent focus:border-amber-400 outline-none placeholder-slate-450 transition-all ${
